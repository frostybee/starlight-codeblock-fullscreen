...
- **Type**: `number`
- **Default**: `150`
- **Description**: The duration of the fullscreen animation in milliseconds. Controls how fast the transition to and from fullscreen mode occurs.
...
:::note
The above configuration customizes the tooltip text, enables both escape key and back button navigation, adds fullscreen buttons only to titled code blocks, sets a zoom level of 120% for better readability in fullscreen mode, uses custom SVG icons, and sets a slower animation duration of 200ms.
:::
...
- Animation duration can be adjusted to match your site's design preferences.
