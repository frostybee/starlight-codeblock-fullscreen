...
The plugin provides state management to ensure a reliable user experience:
...
- **Zoom state**: Manages the zoom level of code blocks independently from the rest of the page. However, if the user zooms the page, the zoom level of the code blocks will be adjusted to match the page zoom level.
